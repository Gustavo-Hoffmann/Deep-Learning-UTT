...
Device usado nesta execução: **privateuseone:0** (GPU AMD via DirectML)
...
| Treinamento | 13.0 s |
| Avaliação/inferência | 0.5 s |
| Script total | 21.5 s |
| Melhor época | 1 |
| Melhor val_loss | 1.0651642978191376 |
| Melhor val_RMSE | 2.1019028425216675 cm |
